...
if tArgs[1] == nil then
 ...
 local decks = {pop = deck1 , myce = deck2 , admin = deck3 , artic = deck4 , phantom = deck5}
 local prime_color = {pop = colors.orange , myce = colors.purple , admin = colors.white , artic = colors.green, phantom = colors.lightGray} 
 local second_color = {pop = colors.lightGray , myce = colors.yellow , admin = colors.white , artic = colors.orange , phantom = colors.orange}
